...
#!/usr/bin/python
# coding=utf-8
# coded by : Devil-Habib 
# https://www.facebook.com/habib.trmx
...
\033[1;97m            @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m           @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m          @@@•••••••••••Devil•••••••@@@ \033[1;0m
\033[1;97m         @@@••••••••••Habib•••••••@@@ \033[1;0m
\033[1;97m        @@@•••••Fucked man•••@@@ \033[1;0m
\033[1;97m       @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m      @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;93m➤\033[1;97m Author   : Tiger-Devil
\033[1;93m➤\033[1;97m Github   : https://github.com/TERmuxkiler
\033[1;93m➤\033[1;97m Fb Id  : https://facebook.com/Xami.Devil
\033[1;97m--------------------------------------------------
"""
...
def tech_abm():
    ...
    if username =="Tiger":
        ...
        if passwordss =="habib":
            ...
            os.system("clear")
            print logo 
            print ("\033[1;97m[+]\033[1;92m Username : devil\033[1;92m (Correct)")
            print ("\033[1;97m[+]\033[1;92m Password : habib\033[1;92m (Correct)")
	    print("\033[1;97m--------------------------------------------------")
            time.sleep(1)
            print('')
	    ...
	    os.system('xdg-open https://m.facebook.com/habib.trmx')
            time.sleep(1)
            tech_abm()
    else:
